    ...
    return {
        addTodo: function(title, description, session, callback) {
            ...
            if (userIsAuthorized) {
                ...
                callback({code : 401, message : "ERROR 401 - User is not authorized to make this request..."}, {
                    previousTitle : title,
        ...
        getAllTodos: function(session, callback) {
            ...
            if (userIsAuthorized) {
                ...
                callback({code : 401, message : "ERROR 401 - Please login to view Todo tasks."}, null)
            }
        },
